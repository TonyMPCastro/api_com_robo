    ...
    if isfile(name_file):
        ...
        if len(content.Paragraphs) != 0:
            for paragraph in content.Paragraphs:
                ...
                elif paragraph.Alignment == win32.constants.wdAlignParagraphLeft:
                    marked_text += "<p>"
                elif paragraph.Alignment == win32.constants.wdAlignParagraphRight:
                    marked_text += "<p  style='text-align:right'>"
                elif paragraph.Alignment == win32.constants.wdAlignParagraphJustify:
                ...
                marked_text += paragraph.Range.Text
                # Fechar a tag p
                marked_text += "</p>"
...
def gerar_json(path,files,limit = 1000000):
    ...
    for file in files:
        ...
        caminho_destino = "C:/xampp/htdocs/api_com_robo/b_laudos/"+str(count2)
        
        if not os.path.exists(caminho_destino):
            os.makedirs(caminho_destino)

        caminho_destino = caminho_destino+"/" +file
...
path = "C:/xampp/htdocs/api_com_robo/a_laudos"
